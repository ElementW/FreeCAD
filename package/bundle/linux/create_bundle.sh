...
rm -rf \
    ...
    \
    ${conda_env}/lib/libarcher.so.bak \
    ${conda_env}/lib/libasan.* \
    ${conda_env}/lib/libhwasan.* \
    ${conda_env}/lib/libgmock*.* \
    ${conda_env}/lib/libgtest.* \
    ${conda_env}/lib/liblsan.* \
    ${conda_env}/lib/libtsan.* \
    ${conda_env}/lib/libubsan.* \
    ${conda_env}/lib/libnode.so.* \
    ${conda_env}/lib/libclang-cpp.so.* \
    ${conda_env}/lib/libclang.so.* \
    ${conda_env}/lib/libLLVM-*.so \
    ${conda_env}/lib/libLLVM.so.* \
    \
