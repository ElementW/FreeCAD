...
int MaterialTreeWidgetPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
    ...
    if (PyArg_ParseTuple(args, "O", &obj)) {
        if ((QLatin1String(obj->ob_type->tp_name) == QStringLiteral("PySide2.QtWidgets.QWidget")) ||
            (QLatin1String(obj->ob_type->tp_name) == QStringLiteral("PySide6.QtWidgets.QWidget"))) {
